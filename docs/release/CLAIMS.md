...
| **Streamed VCS Diff** | PASS CANDIDATE | `packages/vcs/test/vcs-spill.test.ts`, `packages/vcs/test/vcs-security.test.ts` | "Large diffs spill through a bounded writer after sensitive-path filtering" |
