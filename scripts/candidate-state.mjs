...
function isGeneratedEvidence(relativePath) {
  ...
  return /^evidence\/PN\d+\.json$/i.test(normalized) || normalized === "evidence/track-b-host-bypass-2026-09-13.json" || normalized === "evidence/track-c-mcp-apps-2026-09-13.json";
}
