...
export async function main(argv = process.argv.slice(2)) {
  ...
  try {
    ...
    const evidence = {
      ...
      registrationCommit: result.registrationCommit,
      registrationTimestamp: result.registrationTimestamp,
      taskDefinitionBlob: result.taskDefinitionBlob,
      registrationReceiptBlob: result.registrationReceiptBlob,
